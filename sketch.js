...
var ground, invisibleGround, groundImage,gOrImg,rtImg,gameOver,restart;
...
function setup() {
  ...
  gameOver.addImage("game_over",gOrImg);
  gameOver.visible = false;
  
  restart = createSprite(400,250);
  restart.addImage("restart",rtImg);
